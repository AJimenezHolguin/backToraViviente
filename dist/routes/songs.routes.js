...
router.get(`/songs/user`, auth_middleware_1.default, (0, validateRole_1.validateRole)([auth_1.Roles.Admin]), getAllSongs_controller_1.getSongsValidation, pagination_validation_1.handlePaginationValidation, getSongsByUser_controller_1.getSongsByUser);
